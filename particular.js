...
Emitter.prototype.update = function(deltaTime)
{
	...
	{
		this.particles[this.cur_particles_index].x = this.x;
		this.particles[this.cur_particles_index].y = this.y;
		
		this.particles[this.cur_particles_index].cur_lifet_time = this.particles[this.cur_particle_index].life_time;
		...
		if(rand_dir)
		{
			...
			this.particles[this.cur_particles_index].vel_x = this.dir_x / length;
			this.particles[this.cur_particles_index].vel_y = this.dir_y / length;
		}
		else
		{
			this.particles[this.cur_particles_index].vel_x = this.dir_x;
			this.particles[this.cur_particles_index].vel_y = this.dir_y;
		}
